  ...
  return (
    <Layout>
      ...
      <article className={styles.article}>
        ...
        <p>
          Jumping from Processing to Python meant I lost many of the useful creative tools I&apos;d relied on. Since then, I&apos;ve been iteratively developing a <a href="https://github.com/kylestew/geom">custom library</a> and set of tools for Python, allowing for high-resolution 2D graphics. The library uses <a href="https://pycairo.readthedocs.io/en/latest/">Cairo</a> for rendering and is heavily inspired by <a href="http://thi.ng/">thi.ng</a>. I&apos;ve found that the open-ended nature of Python allows me to develop the library without breaking my flow as I create new art pieces.
        </p>
