...
function animate() {
    ...
    cursors[0] = Math.round(Math.sin(Date.now() * 0.0002) * (grid.width / 8))
    cursors[1] = Math.round(Math.sin(Date.now() * 0.0003) * (grid.width / 8))
    cursors[2] = Math.round(Math.sin(Date.now() * 0.00025) * (grid.width / 8))
